...
function _renderAuthScreen(msg){
 ...
 root.innerHTML = `<div class="auth-screen"><div class="auth-card">
  <div class="auth-brand"><div><h1>Financial Model Manager</h1><p>Acceso por usuario, rol y contraseña. El username se genera automáticamente con la primera letra del nombre y el apellido.</p></div><p style="font-size:11px;opacity:.72">Roles: Admin puede ver usuarios y todos los proyectos. Member trabaja con sus proyectos.</p></div>
  <div class="auth-form">
   ...
   <div id="auth-login-box">
    <div class="auth-field"><label>Username</label><input id="login-username" placeholder="ej. mtrujillo"></div>
   ...
   <div id="auth-reg-box" style="display:none">
    <div class="auth-grid"><div class="auth-field"><label>Nombre</label><input id="reg-first" placeholder="Micaela"></div><div class="auth-field"><label>Apellido</label><input id="reg-last" placeholder="Trujillo"></div></div>
