...
function compute() {
 ...
 // finExpCB/UB shown as separate Bond Fees rows
 ...
 // finExpCB/UB subtracted explicitly in netCF — not in costCatCF
...
function renderGroupedPLCF(which, cv) {
 ...
 body += mkRow('Compliance Bond Fee', cv.finExpCB, {ind:true, color:'amber'});
 body += mkRow('Upfront Bond Fee',    cv.finExpUB, {ind:true, color:'amber'});
